...
var (
	...
	calcDifficultyEip5133 = makeDifficultyCalculator(big.NewInt(11_400_000)) // Max seconds from current time allowed for blocks, before they're considered future blocks
